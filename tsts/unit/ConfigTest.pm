...
sub test_get_list
{
    ...
    $self->assert_equals(3, $obj->get_single_value('gubber', {foo => 'boo'}));
    $self->assert_deep_equals([2, 4, 5], $obj->get_value('hubber', {foo => 'boo'}));
...
#     # Since the block has no selects, we can pass in any selectors and it should succeed
#     $self->assert_equals(3, $obj->get_single_value('gubber', {foo => 'boo'}));
#     #$self->assert_equals(4, $obj->get_single_value('hubber', {foo => 'boo'}));

#     return;
# }

# sub test_get_with_selectors
# {
#     my $self = shift;
#     Idval::FileString::idv_add_file('/testdir/gt1.txt', "{\nfoo == boo\ngubber = 3\nhubber=4\n}\n");
...
#     my $obj = Idval::Config->new('/testdir/gt1.txt');
#     # Since the block has no selects, we can pass in any selectors and it should succeed
#     $self->assert_equals('pachoo', $obj->get_single_value('gubber', {foo => 'boo'}));
#     $self->assert_equals(4, $obj->get_single_value('hubber', {foo => 'boo'}));
...
#     my $obj = Idval::Config->new('/testdir/gt1.txt');
#     # Since the block has no selects, we can pass in any selectors and it should succeed
#     $self->assert_equals('', $obj->get_single_value('flubber', {foo => 'boo'}));
...
#     # Since the block has no selects, we can pass in any selectors and it should succeed
#     my $obj = Idval::Config->new('/testdir/gt1.txt');
#     $self->assert_equals('pachoo nachoo "huggery muggery" hoofah', $obj->get_value('gubber', {foo => 'boo'}));
...
#     my $result = {
#         'command_extension' => 'pm',
#         'demo_validate_cfg' => '/home/bob/Projects/src/idv/data/val_demo.cfg',
#         'command_dir' => '/home/bob/Projects/src/idv/data/commands',
#         'plugin_dir' => '/home/bob/Projects/src/idv/lib/Plugins',
#         'data_store' => '/home/bob/Projects/src/idv/data/data_store.bin',
#         'visible_separator' => '%%'
#     };
...
#     $self->assert_deep_equals($vars, $result);
# }

# sub test_get_one_value
# {
#     my $self = shift;
...
#     $self->assert_equals('bouncy', $val);
#     #print "val is: \"$val\"\n"; # should be 'bouncy'
# }

# sub test_get_value_using_two_selectors
# {
#     my $self = shift;
...
#     $self->assert_equals('pachoo wachoo', $val);
# }

# sub test_get_value_using_selector_list
# {
#     my $self = shift;
...
# sub test_get_values_including_sub_block
# {
#     my $self = shift;
...
# sub test_no_back_adding_of_inherited_values
# {
#     my $self = shift;
...
# # Yep!
# sub test_no_back_adding_of_other_values
# {
#     my $self = shift;
